...
export interface MockupCanvasProps {
    ...
    onThreadApplySuggestion?: () => void | Promise<void>;
    ...
    return (
        <div className="mockup-stage">
            <div
                ...
                style={{
                    width: zen ? "100%" : Math.min(viewport, 1600),
            ...
            >
                {srcdoc ? (
                    ...
                    <div className="empty-state">
                        <p className="empty-state-hint">Loading screen…</p>
                    </div>
                )}
                <div className="mockup-overlays">
                    {!viewOnly && hover?.rect && !pending && !selectedId && (
                        <div
                    ...
                    {!viewOnly &&
                        pinnedComments.map((c, i) => (
                            <CanvasPin
                                ...
                                comment={c}
                                index={i}
                                offset={pinStackOffset(pinnedComments, i)}
            ...
            {!viewOnly && selected && (
                ...
                >
                    <MockupThread
                        ...
                        onDeleteReply={onThreadDeleteReply}
                        onApplySuggestion={onThreadApplySuggestion}
                        aiContext={aiContext}
                    />
                </MockupFloatCard>
            )}
            {!viewOnly && pending && (
                <MockupComposer
                    ...
                    aiContext={aiContext}
                    onRewriteRegion={
                        pending.target ? onRewriteRegion : undefined
                    }
                    rewriting={rewriting}
                />
            )}
