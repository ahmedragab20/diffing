  ...
  const diffCategories: ShortcutCategory[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { keys: ['s'], description: 'Search symbols (Symbols scope, changed files only)' },
        { keys: ['g', 's'], description: 'Search symbols (same as s)' },
        { keys: ['g', 't'], description: 'Open Theme Selection Modal' },
        { keys: ['Alt', '1–4'], description: 'Switch search scope: All, Files, Text, Symbols' },
        { keys: ['Tab'], description: 'Move focus between palette controls (scope tabs use ←/→)' },
        { keys: ['Ctrl', 'G'], description: 'Toggle Changed-only filter (in palette)' },
        { keys: ['Ctrl', 'R'], description: 'Toggle regex mode (Text scope, in palette)' },
        { keys: ['Ctrl', 'L'], description: 'Clear search query (in palette)' },
        { keys: ['Ctrl', 'U'], description: 'Page result list up (in palette)' },
        { keys: ['Ctrl', 'D'], description: 'Page result list down (in palette)' },
        { keys: ['↑', '↓'], description: 'Move selection in result list (in palette)' },
        { keys: ['Enter'], description: 'Jump to selected match (in palette)' },
        { keys: ['⌘', '↵'], description: 'Peek a result in the preview pane (in palette)' },
        { keys: ['Esc'], description: 'Close palette, or unfocus preview first (two-stage, in palette)' },
        { keys: ['n'], description: 'Next search result (after palette closes)' },
        { keys: ['N'], description: 'Previous search result (after palette closes)' },
    ...
    },
    {
      ...
      items: [
        ...
        { keys: ['#'], description: 'Toggle Line Numbers' },
        { keys: ['g', 'n'], description: 'Toggle Line Numbers (same as #)' },
        { keys: ['Settings'], description: 'Toggle Line Numbers (settings panel)' },
