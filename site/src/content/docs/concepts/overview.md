...
summary: diffing is a local-first git diff review tool for humans and AI agents with web UI, TUI, plan review, and MCP.
order: 1
section: concepts
---
...
|---------|---------|------|
| Web review UI | `diffing` / `--web` | Full review: comments, plans, search, themes |
